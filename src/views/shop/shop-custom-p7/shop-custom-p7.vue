...
const userId = customStore.userId
const total_price = customStore.total_price
const productsStore = customStore.customMes.products
...
const showComboPrice = computed(() => {
  ...
  customStore.total_price = totalPrice
...
// 点击下一步获取当前所有选择的信息，并添加到订单中
const nextPageClick = () => {
  // 获取当前的套餐信息，并提交到订单中
  var customMes = customStore
  var orderListObj = {}
  orderListObj.user_id = customMes.userId
  orderListObj.user_name = customMes.user_name
  orderListObj.total_price = customMes.total_price
  ...
  var order_id = customMes.userId + '_' + formatTimeID + '_' + customMes.total_price
